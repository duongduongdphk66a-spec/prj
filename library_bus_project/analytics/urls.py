...
urlpatterns = [
    ...
    path('books/<int:book_id>/', views.BookDetailAnalyticsView.as_view(), name='book_detail_analytics'),
    ...
    # API endpoints
    path('api/track/book/<int:book_id>/', views.track_book_view, name='track_book_view'),
    path('api/track/recommendation/<int:recommendation_id>/', views.track_recommendation_click, name='track_recommendation_click'),
    path('api/track/bus/<int:bus_id>/', views.track_bus_visit, name='track_bus_visit'),
