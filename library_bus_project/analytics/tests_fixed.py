...
class AnalyticsModelsTest(BaseAnalyticsTest):
    def setUp(self):
        ...
        self.book1 = Book.objects.create(id=1, title='The Great Novel', author='Author A')
        self.book2 = Book.objects.create(id=2, title='Another Story', author='Author B')
        self.bus1 = LibraryBus.objects.create(id=1, name='Bus Alpha')
        self.bus2 = LibraryBus.objects.create(id=2, name='Bus Beta')
...
class AnalyticsViewsTest(BaseAnalyticsTest):
    def setUp(self):
        ...
        self.book1 = Book.objects.create(id=1, title='Test Book 1', author='Author A')
        self.book2 = Book.objects.create(id=2, title='Test Book 2', author='Author B')
        self.bus1 = LibraryBus.objects.create(id=1, name='Test Bus 1')
...
class AnalyticsTasksTest(BaseAnalyticsTest):
    def setUp(self):
        self.user = User.objects.create_user(username='testuser', password='password')
        self.book = Book.objects.create(id=1, title='Task Test Book')
        self.bus = LibraryBus.objects.create(id=1, name='Task Test Bus')
        cache.clear()
...
class AnalyticsAdminTest(BaseAnalyticsTest):
    def setUp(self):
        ...
        self.user1 = User.objects.create_user(username='testuser1', password='password1')
        self.book1 = Book.objects.create(id=1, title='Admin Test Book 1')
        self.bus1 = LibraryBus.objects.create(id=1, name='Admin Test Bus 1')
