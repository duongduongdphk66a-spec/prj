...
JAZZMIN_SETTINGS = {
    ...
    "icons": {
        ...
        "transactions.Reservation": "fas fa-clock",
        "analytics.DailyStat": "fas fa-chart-line",
        "analytics.BookStat": "fas fa-chart-bar",
        "analytics.BusStat": "fas fa-chart-pie",
        "analytics.ReadingStat": "fas fa-book-reader",
